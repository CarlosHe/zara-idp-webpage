...
- Name: journeys/a11y-audit.spec.ts >> a11y audit (axe-core, all major routes) >> route /runtime has zero critical/serious axe violations
- Location: e2e/journeys/a11y-audit.spec.ts:108:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4173/runtime
Call log:
  - navigating to "http://localhost:4173/runtime", waiting until "load"
