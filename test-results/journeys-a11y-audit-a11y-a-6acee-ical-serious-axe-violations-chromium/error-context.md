...
- Name: journeys/a11y-audit.spec.ts >> a11y audit (axe-core, all major routes) >> route /golden-paths has zero critical/serious axe violations
- Location: e2e/journeys/a11y-audit.spec.ts:108:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4173/golden-paths
Call log:
  - navigating to "http://localhost:4173/golden-paths", waiting until "load"
